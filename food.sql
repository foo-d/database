...
BEGIN
    UPDATE employee
    SET used = used + DATEDIFF(new.end, new.start)
...
BEGIN
    UPDATE employee
    SET used = used - DATEDIFF(old.end, old.start)
...
INSERT INTO leaves VALUES (NULL, "2020-12-24 00:00:00", "2020-12-26 00:00:00", 1);
